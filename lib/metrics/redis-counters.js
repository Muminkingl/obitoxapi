...
// ============================================================================
// LEGACY SCAN FUNCTIONS (kept for backward compat during transition)
// Old keys will expire naturally within 7 days
// ============================================================================

/**
 * Scan for old-format API key metrics (metrics:apikey:*)
 * @deprecated Use getPendingMetrics() instead
 */
...
/**
 * Scan for old-format provider metrics (metrics:provider:*)
 * @deprecated Use getPendingMetrics() instead
 */
...
/**
 * Scan for old-format daily API key metrics
 * @deprecated Use getPendingMetrics() instead
 */
...
/**
 * Scan for old-format daily provider metrics
 * @deprecated Use getPendingMetrics() instead
 */
